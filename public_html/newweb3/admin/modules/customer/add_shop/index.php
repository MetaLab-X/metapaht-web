...
<script>
	function checkData()
	{
	var allert = ["", "คำเตือน : ชื่อ - นามสกุล","คำเตือน : ที่อยู่","คำเตือน : จังหวัด","คำเตือน : อำเภอ","คำเตือน : ตำบล","คำเตือน : อีเมล์","คำเตือน : เบอร์โทรศัพท์","คำเตือน : แฟ็กซ์","คำเตือน : เลขประจำตัวผู้เสียภาษี","คำเตือน : ประเภทร้าน","คำเตือน : สิทธิการขาย","คำเตือน : ชื่อผู้ติดต่อ","คำเตือน : เบอร์ผู้ติดต่อ"];
		<?php for($i=1;$i<=13;$i++){?>
...
<div class="col-md-12" style="background-color:#364150; padding-top:15px; padding-bottom:15px; font-size:20px;" align="center"> <font color="#fff">เพิ่มข้อมูลสาขาย่อย </font> </div>
