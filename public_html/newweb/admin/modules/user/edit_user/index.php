...
<form action="form.php" method="post" enctype="multipart/form-data" name="formEditer" target="addForm" onsubmit="return checkData();">
  ...
  <div class="row" style="padding-bottom:40px;">
      ...
      <div width="80%" style="padding-top:15px;">
          ...
          <option value="admin" <?php if($em_data[2]=="admin"){echo "selected='selected'";} ?>>admin</option>
          <option value="user" <?php if($em_data[2]=="user"){echo "selected='selected'";} ?>>user</option>
        </select>
      </div>
       <div class="col-xs-12"></div>
       <div width="20%" >ชื่อผู้ดูแล :</div>
      <div width="80%" style="padding-top:15px;">
        <input id="txt1" name="txt1" type="text" class="form-control" value="<?=$em_data[3]?>" placeholder="ชื่อผู้ดูแล" style="width:100%; height:40px;">
      </div>

      <div class="col-xs-12"></div>
      <div width="20%">Username : </div>
        <div width="80%" style="padding-top:15px;">
          <input id="txt2" name="txt2" type="text" class="form-control" value="<?=$em_data[4]?>" placeholder="Username" style="width:100%; height:40px;">
        </div>

      <div class="col-xs-12"></div>
      <div width="20%">Password : </div>
        <div width="80%" style="padding-top:15px;">
          <input id="txt3" name="txt3" type="text" class="form-control" value="<?=$em_data[5]?>" placeholder="รหัสผ่าน 6-8 ตัวอักษร" style="width:100%; height:40px;">
        </div>
