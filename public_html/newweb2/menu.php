...
<a href="#" class="nav-item nav-anchor nav-click" id="h" title="หน้าแรก" data-scroll="home"  style="font-size:17px; letter-spacing:1px;">
    HOME
</a>
...
<a href="#" class="nav-item nav-anchor nav-click" title="แนวคิดของเมธาพัฒน์" data-scroll="Concept" style="font-size:17px;  letter-spacing:1px;">
    CONCEPT
</a>
