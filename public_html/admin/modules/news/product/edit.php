 ...
 $dataAr=Get_product_data($editID);
 ?>
...
<div class="pageModuleTitle" style="font-size:19px;">
 ...
 <div class="col-xs-12 col-sm-12 col-md-12" align="right" style="font-size:19px;">
   <a href="<?php echo $pathBack;?>" title="กลับหน้า Service">
 ...
 <form action="<?=$path;?>/product/function/edit.php" method="post" enctype="multipart/form-data" name="formEditer" target="iframePath" onsubmit="return checkData();">
  <input name="set_DB" type="hidden" value="<?php echo $database;?>">
  <input name="set_Action" type="hidden" value="editArticle">
  <input name="set_EID" type="hidden" value="<?php echo $editID?>">
    ...
    <div class="col-xs-12 col-sm-10 col-md-10" align="left" style="font-size:19px; padding-left:0px; padding-right:0px;">
     <select name="ar_category1" id="ar_category1" style="height:35px; border-radius:5px; padding-left:5px; padding-right:5px; max-width:100%; width:320px;" onchange="data_show(this.value,'ar_category2');">
      ...
      for($c_cat=1;$c_cat<=$typeList[0][0];$c_cat++){
        ?>
        <option value="<?php echo $typeList[$c_cat][1];?>" <?php if($typeList[$c_cat][1]==$dataAr[1][2]){ echo "selected='selected'";}?>><?php echo $typeList[$c_cat][2];?></option>
  ...
  <div class="container" style="padding-top:20px; padding-left:0px; padding-right:0px;">
    ...
    <div class="col-xs-12 col-sm-10 col-md-10" align="left" style="font-size:19px; padding-left:0px; padding-right:0px;">
      <input type="text" name="title1" id="title1" class="textBox" value="<?php echo $dataAr[1][4];?>" />
    </span></div>
  </div>
  <div class="container" style="padding-left:0px; padding-right:0px;">
    <div class="col-xs-12 col-sm-2 col-md-2" align="left" style="font-size:19px; padding-top:5px;padding-left:0px; padding-right:0px;">Title EN :</div>
    <div class="col-xs-12 col-sm-10 col-md-10" align="left" style="font-size:19px; padding-top:5px;padding-left:0px; padding-right:0px;"><input type="text" name="title2" id="title2" class="textBox" value="<?php echo $dataAr[1][5];?>"></div>
  </div>
  
  <div class="container" style="padding-top:20px; padding-left:0px; padding-right:0px;">
    <div class="col-xs-12 col-sm-2 col-md-2" align="left" style="font-size:19px; padding-left:0px; padding-right:0px;">Keyword TH :</div>
    <div class="col-xs-12 col-sm-10 col-md-10" align="left" style="font-size:19px; padding-left:0px; padding-right:0px;"><input type="text" name="title3" id="title3" class="textBox" value="<?php echo $dataAr[1][6];?>"></div>
  </div>
  <div class="container" style="padding-left:0px; padding-right:0px;">
    <div class="col-xs-12 col-sm-2 col-md-2" align="left" style="font-size:19px; padding-top:5px; padding-left:0px; padding-right:0px;">Keyword EN :</div>
    <div class="col-xs-12 col-sm-10 col-md-10" align="left" style="font-size:19px; padding-top:5px; padding-left:0px; padding-right:0px;"><input type="text" name="title4" id="title4" class="textBox" value="<?php echo $dataAr[1][7];?>"></div>
  </div>
  ...
  <div class="container" style="padding-top:20px; padding-left:0px; padding-right:0px;">
    ...
    <div class="col-xs-12 col-sm-10 col-md-10" align="left" style="font-size:19px; padding-left:0px; padding-right:0px;">
      <textarea name="title5" class="textBox" id="title5" style="min-height:100px; max-height:100px;"><?php echo $dataAr[1][8];?></textarea>
    </div>
  </div>
  <div class="container" style="padding-left:0px; padding-right:0px;">
    <div class="col-xs-12 col-sm-2 col-md-2" align="left" style="font-size:19px; padding-top:5px; padding-left:0px; padding-right:0px;">Description EN :</div>
    <div class="col-xs-12 col-sm-10 col-md-10" align="left" style="font-size:19px; padding-top:5px; padding-left:0px; padding-right:0px;">
      <textarea name="title6" class="textBox" id="title6" style="min-height:100px; max-height:100px;"><?php echo $dataAr[1][9];?></textarea>
    </div>
  </div>
  ...
  <div class="container" style="padding-top:20px; padding-left:0px; padding-right:0px;">
    ...
    <div class="col-xs-12 col-sm-10 col-md-10" align="left" style="font-size:19px; padding-top:5px; padding-left:0px; padding-right:0px;">
     <textarea name="message" cols="100" rows="30" id="message"  style="width:100%;"> <?php echo $dataAr[1][10];?></textarea>
     <script type="text/javascript">
  ...
  <div class="col-xs-12 col-sm-10 col-md-10" align="left" style="font-size:19px; padding-top:8px; padding-left:0px; padding-right:0px;">
   <textarea name="message2" cols="100" rows="30" id="message2"  style="width:100%;"><?php echo $dataAr[1][11];?> </textarea>
   <script type="text/javascript">
...
<div class="container" style="padding-top:20px; padding-left:0px; padding-right:0px;">
  <div class="col-xs-12 col-sm-2 col-md-2" align="left" style="font-size:19px; padding-left:0px; padding-right:0px;"></div>
  <div class="col-xs-12 col-sm-10 col-md-10" align="left" style="font-size:19px; padding-left:0px; padding-right:0px;">
    <img src="../<?php echo $dataAr[1][12];?>" width="350" style="border:1px #000 solid; max-width:100%;">
  </div>
</div>
