<?php
	...
	$zonID=$_REQUEST['viewID'];
	$zoneData=get_Zonedata($zonID);
?>
...
<iframe id="addForm" name="addForm" src="" style="width:100%;height:400px;border:0px; display:none;"></iframe>
  <div class="col-md-12" style="background-color:#364150; padding-top:15px; padding-bottom:15px;" align="center">
    <font color="#fff">แก้ไขพื้นที่การขาย</font>
  </div>
...
<input name="zoneID" id="zoneID" type="hidden"  value="<?=$zoneData[1];?>">
	<div class="col-xs-2"></div>
  <div class="col-xs-8" style="padding-top:10px;">
    <input type="text" name="zone" id="zone" class="form-control" placeholder="พื้นที่การขาย" value="<?=$zoneData[2];?>">
  </div>
  <div class="col-xs-2"></div>
