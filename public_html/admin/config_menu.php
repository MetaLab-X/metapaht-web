...
<li class="dropdown">
 <a class="dropdown-toggle" data-toggle="dropdown">
   <div <?php if($page=="Category" || $page == "List" || $page=="NewsTitle"){echo "class='MENU_Active'";} else {echo "class='MENU'";}?> >
     <i class="glyphicon glyphicon-pencil" aria-hidden="true" style="padding:5px; font-size:15px;"></i>NEWS
   </div>
 </a>
 <ul class="dropdown-menu">
   <li><a href="index.php?content=NewsTitle&view=5">
    <div <?php if($page=="NewsTitle"){echo "class='MENU_Active'";} else {echo "class='MENU'";}?>>
      <span class="glyphicon glyphicon-triangle-right" aria-hidden="true" style="padding:5px; font-size:13px;"></span>SET HEADER PAGE
    </div>
  </a></li>

  <li><a href="index.php?content=Category&view=1">
    <div <?php if($page=="Category"){echo "class='MENU_Active'";} else {echo "class='MENU'";}?>>
      <span class="glyphicon glyphicon-triangle-right" aria-hidden="true" style="padding:5px; font-size:13px;"></span>NEWS CATEGORY
    </div>
  </a></li>

  <li><a href="index.php?content=List&view=3">
    <div <?php if($page=="List"){echo "class='MENU_Active'";} else {echo "class='MENU'";}?> >
     <span class="glyphicon glyphicon-triangle-right" aria-hidden="true" style="padding:5px; font-size:15px;"></span>NEWS LIST
   </div>
 </a></li>       
</ul>
</li>
