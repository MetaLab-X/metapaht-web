...
function uploadok(){	window.location="index.php?content=employee";	}
...
<img src="assets/images/bg-images.jpg" id="bg" alt="">
    ...
    <form action="check_user_login.php" method="post" name="metapahtLogin" id="metapahtLogin" onSubmit="return validateData()" target="checklogin">
    	...
    	<div class="classPanelLogBG classPanellogin classMaginPosition">
  ...
  <div class="input-group margin-bottom-sm">
  	<span class="input-group-addon" style="border-radius:5px 0px 0px 0px; background-color:#FFF; border-bottom:1px #f0f0f0 solid; border:0px;">
    	<i class="fa fa-envelope-o fa-fw" aria-hidden="true" style="background-color:#FFF;"></i>
    </span>
 		<input class="form-control" type="text" placeholder="Username" id="metapaht_user_name" name="metapaht_user_name" style="border-radius:0px 5px 0px 0px; background-color:#FFF; border-bottom:1px #f0f0f0 solid; font-size:12px; border-left:0px;">
	</div>
...
<div class="input-group">
 ...
 <input class="form-control" type="password" placeholder="Password"  id="metapaht_user_password" name="metapaht_user_password" style="border-radius:0px; background-color:#FFF; border-top:1px #f0f0f0 solid; font-size:12px; border-left:0px;">
</div>
<div class="input-group">
