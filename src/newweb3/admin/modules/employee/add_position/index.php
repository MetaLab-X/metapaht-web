...
<script>
	function checkData()
	{
	var allert = ["คำเตือน : รหัสพนักงาน","คำเตือน : ชื่อตำแหน่งงาน", "คำเตือน : ชื่อ", "คำเตือน : นามสกุล","คำเตือน : เบอร์โทรศัพท์","คำเตือน : อีเมล์","คำเตือน : ที่อยู่","คำเตือน : ตำแหน่ง","คำเตือน : สถานะ","คำเตือน : รหัสผ่าน"];
...
<form action="form.php" method="post" enctype="multipart/form-data" name="formEditer" target="addForm" onsubmit="return checkData();">
  ...
  <div class="col-md-12" style="background-color:#364150; padding-top:15px; padding-bottom:15px;" align="center">
    <font color="#fff">เพิ่มข้อมูลตำแหน่งงาน</font>
  </div>
  <div class="row" style="padding-bottom:40px;">
       <div class="col-xs-1"></div>
      <div class="col-xs-8" style="padding-top:15px;">
        <input id="txt1" name="txt1" type="text" class="form-control" placeholder="ตำแหน่งพนักงาน" style="width:100%; height:40px;">
      </div>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px #e8e8e8 solid;">
				...
				<tr style="font-weight:bold;">
                    ...
                    <td height="35" align="center" valign="middle" bgcolor="#f0f0f0"  style="border-bottom:1px #9b9b9b solid;">สถานะ</td>
